    ...
    <nav>
     <div className='flex justify-between items-center'>
      ...
      <div className='hidden lg:flex items-center font-bold gap-4 text-xl uppercase'>
       <Link className='underline-fancy' href='/login'>
        Log In
       </Link>
       <Link className='underline-fancy' href='/register'>
        Register
       </Link>
      </div>

      {/* Mobile Hamburger */}
      <button className='lg:hidden' onClick={() => setMenuOpen((prev) => !prev)} aria-label='Toggle menu'>
