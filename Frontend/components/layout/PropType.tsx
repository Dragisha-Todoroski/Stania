        ...
        <div className="toprop_content flex flex-col gap-10">
          ...
          <div className="topprop_list grid lg:grid-cols-4 md:gap-6 xs:grid-cols-2 gap-4 grid-cols-1">
            {listContent.map(
              ({ id, imgsrc, alt, title}) => (
                <div
                  className="topprop_list_item  rounded-xl overflow-clip h-max w-auto drop-shadow-md"
                  key={id}
                >
                  <img
                    loading="lazy"
                  ...
                  />
                  <div className="toprpop_item_text xs:px-6 xs:pb-8 xs:pt-4 px-4 pb-6 pt-2 h-fill bg-[#222222] flex flex-col gap-3">
